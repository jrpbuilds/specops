...
- [x] 11.8 Verify Phase 10: every required end-to-end scenario has evidence; two model families complete representative workflows; documentation matches runtime; packed installation succeeds; no generated or bundled custom schema remains; the version is ready to become `1.0.0`
